      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4 text-sm leading-relaxed">
            <p>
              Zebra is a daily logic-grid puzzle inspired by the Einstein riddle,
              but tuned down for an easier puzzle solving experience. Read the
              clues, deduce which person sits where, and commit each cell against
              the clock.
            </p>
            <p>
              ...
              grid, available every Friday for people that really love hard
              puzzles. Every commit is final and counts; your score is the number
              of times you changed your mind. Zero overwrites is{" "}
            ...
            <p>
              ...
              Toronto time. No accounts (unless you want to sync streak across
              devices), no hints beyond a single check, no live correctness
              feedback until the whole grid is solved correctly. Just you and the
              grid.
            </p>
          </div>
        </div>
